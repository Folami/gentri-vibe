export const creatorPortalsData = {
  hero: {
    title: "Creator Portals to Amplify \n Your Creative Flow 🎨",
  ...
  perfectFor: [
    ...
    {
      title: 'Content Creators & Digital Artists 🎨',
      desc: 'Portfolio paywalls for clients, tutorial sales via secure links, community engagement bots. Showcase your portfolio in 8K. Sell NFTs, prints, and commission slots with zero friction.'
    },
    {
      title: 'Podcasters 🎙️',
  ...
  cta: {
    title: "Ready to elevate your creative vibe? 🚀",
    desc: "Join the community of creators who are owning their future.",
